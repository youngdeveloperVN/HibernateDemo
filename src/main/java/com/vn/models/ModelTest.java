...
public class ModelTest {
	...
	public ModelTest(String id, String firstName, String lastName, String decription, Boolean age, String phone1,
			String phone2, String phone3, String phone4, String phone5, String phone6) {
		super();
		this.id = id;
